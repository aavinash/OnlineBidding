class CompanyDetailsController < ApplicationController
  ...
  private
    ...
    def company_detail_params
      params.require(:company_detail).permit(:company_name, :company_type, :pan, :vat, :registration_number, :company_address, :billing_address, :shipping_address, :company_info)
    end
end
