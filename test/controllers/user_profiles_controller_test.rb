...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { designation: @user_profile.designation, first_name: @user_profile.first_name, last_name: @user_profile.last_name, phone: @user_profile.phone }
    end
  ...
  test "should update user_profile" do
    patch :update, id: @user_profile, user_profile: { designation: @user_profile.designation, first_name: @user_profile.first_name, last_name: @user_profile.last_name, phone: @user_profile.phone }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
